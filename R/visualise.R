...
#' @param discrete An optional boolean to try to force the output to be a bar chart and not a density plot. Be careful when using as results may be unexpected.
#'
...
#'   visualise(vars = c("x1"))
visualise <- function(.data, vars = NULL, discrete = FALSE){
